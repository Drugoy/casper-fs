...
MODULE_DESCRIPTION("Casperfs Version 0.3 - Module to turn a private file in hidden. The second function is to protect a confidential file to prevent reading, writing and removal.");
